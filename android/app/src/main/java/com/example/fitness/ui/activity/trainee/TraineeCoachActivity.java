...
import com.example.fitness.databinding.ActivityTraineeCoachBinding;
import com.example.fitness.ui.adapter.TraineeCoachPagerAdapter;
...
@AndroidEntryPoint
public class TraineeCoachActivity extends AppCompatActivity {
    
    private ActivityTraineeCoachBinding binding;
    private ConnectionsViewModel connectionsViewModel;
    private TraineeCoachPagerAdapter pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTraineeCoachBinding.inflate(getLayoutInflater());
    ...
    private void setupViewPager() {
        pagerAdapter = new TraineeCoachPagerAdapter(this);
        binding.viewPager.setAdapter(pagerAdapter);
        
        new TabLayoutMediator(binding.tabLayout, binding.viewPager, (tab, position) -> {
            switch (position) {
                case 0:
                    tab.setText("Active Coaches");
                    break;
                case 1:
                    tab.setText("Find Coaches");
                    break;
                case 2:
